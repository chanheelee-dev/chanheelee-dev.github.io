...
효율적인 마케팅 예산 집행을 위해 캠페인 별 평생 가치(LTV)를 예측하는 프로젝트. 자세한 문제 상황은 [LTV 전체 설명 문서](./proj_ltv.md)에 적혀 있습니다.

## Stage 1 목적

Stage 1에서의 주요 목적은 **기존 코드 및 대시보드의 유지보수**입니다.
...
- 입력 데이터: 코호트 별 7일 간 유입 유저 수, 매출, 이탈 유저 수
- 출력: 코호트 내 유저들의 365일 평균 LTV 예측값

자세한 모델링 설명은 [LTV MCMC 모델 설명 문서](./ltv_modeling_mcmc.md)에 작성했습니다.
